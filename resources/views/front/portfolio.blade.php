    ...
    <div id="grid-gallery" class="container grid-gallery">
        ...
        <section class="grid-wrap">
            <ul class="row grid">
                ...
                <li>
                    <figure>
                        <img src="{{asset('assets')}}/img/projects/project-1.jpg" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{asset('assets')}}/img/projects/project-2.jpg" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{asset('assets')}}/img/projects/project-3.jpg" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{asset('assets')}}/img/projects/project-4.jpg" alt="Portolio Image" />
                ...
                <li>
                    <figure>
                        <img src="{{asset('assets')}}/img/projects/project-5.jpg" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{asset('assets')}}/img/projects/project-6.jpg" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{asset('assets')}}/img/projects/project-7.jpg" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{asset('assets')}}/img/projects/project-8.jpg" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                ...
                <li>
                    <figure>
                        <img src="{{asset('assets')}}/img/projects/project-9.jpg" alt="Portolio Image" />
                        <div><span>Image Project</span></div>
                    </figure>
                </li>
                <!-- Portfolio Item Ends -->
                        ...
                        <div id="slider" class="carousel slide portfolio-slider" data-ride="carousel" data-interval="false">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{asset('assets')}}/img/projects/project-3.jpg" alt="slide 1">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('assets')}}/img/projects/project-2.jpg" alt="slide 2">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{asset('assets')}}/img/projects/project-1.jpg" alt="slide 3">
                                </div>
                            </div>
                        </div>
                        <!-- Main Project Content Ends -->
                ...
                <li>
                    <figure>
                        ...
                        <video id="video" class="responsive-video" controls poster="{{asset('assets')}}/img/projects/project-1.jpg">
                            <source src="{{asset('assets')}}/img/projects/video.mp4" type="video/mp4">
                        </video>
                        <!-- Main Project Content Ends -->
                    </figure>
                </li>
